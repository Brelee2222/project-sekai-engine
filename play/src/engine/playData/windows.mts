...
export const windows = {
    ...
    traceNote: {
        normal: fromFrames([3.5, 3.5], [3.5, 3.5], [3.5, 3.5]),
        critical: fromFrames([3.5, 3.5], [3.5, 3.5], [3.5, 3.5]),
    },
    traceFlickNote: {
    ...
    slideEndTraceNote: {
        normal: fromFrames([6.5, 8.5], [6.5, 8.5], [6.5, 8.5]),
        critical: fromFrames([6.5, 8.5], [6.5, 8.5], [6.5, 8.5]),
    },
    slideEndFlickNote: {
        normal: fromFrames([3.5, 4], [6.5, 8], [7.5, 8.5]),
        critical: fromFrames([3.5, 4], [6.5, 8], [7.5, 8.5]),
